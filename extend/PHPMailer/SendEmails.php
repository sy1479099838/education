...
class SendEmails
{
    ...
    private static $From = '1294544527@qq.com'; //发送者的邮件地址
    private static $FromName = '沈仁海'; //发送邮件的用户昵称
    private static $Username = '1294544527@qq.com'; //登录到邮箱的用户名
    private static $Password = 'stnbxzyguhvtbabb'; //第三方登录的授权码，在邮箱里面设置
     ...
     */
    public static function SendEmail($title=1,$message=1,$emailAddress,$filePath,$fileName)
    {
        $mail = new PHPMailer();
        ...
        $mail->AddAttachment($filePath,$fileName,"base64");
        //调用send方法，执行发送
        $result = $mail -> Send();
        if($result){
           return true;
